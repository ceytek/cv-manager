...
const translations = {
  tr: {
    ...
    aboutTestDesc: 'Bu test, kişilik özelliklerinizi ve pozisyona uygunluğunuzu değerlendirmek için tasarlanmıştır. Her ifade için en uygun seçeneği işaretleyin. Doğru veya yanlış cevap yoktur.',
  ...
  en: {
    ...
    aboutTestDesc: 'This test is designed to evaluate your personality traits and your fit for the position. Select the most appropriate option for each statement. There are no right or wrong answers.',
