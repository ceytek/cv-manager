...
const LikertPage = ({ token }) => {
  const [step, setStep] = useState('loading'); // loading, welcome, agreement, test, completed, error, expired
          ...
          <div className="likert-welcome-card">
            ...
            <div className="likert-info-grid">
              ...
              <div className="likert-info-card">
                ...
                <div className="likert-info-content">
                  <span className="likert-info-label">{t.estimatedTime}</span>
                  <span className="likert-info-value">~{estimatedMinutes} {t.minutes}</span>
                </div>
              </div>
            </div>
